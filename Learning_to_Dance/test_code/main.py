...
def combine_audio_video(input_video_path, audio_path, output_video_path):
    # Load video clip
...
def test(args,device):
    ...
    audio_model.load_state_dict(torch.load(args.a_ckp_path,map_location ='cpu'))
    ...
    # Combine generated video with actual audio
    input_video_path = args.out_video + video_name + '/' + video_name + "_black.mp4"
    audio_path = args.input  # Path to the actual audio
    output_video_path = args.out_video + video_name + '/' + video_name + "_combined.mp4"
    combine_audio_video(input_video_path, audio_path, output_video_path)
